...
extern "C" void flux_albo_thucpl_(double*, double*, bool*, double*, double*, 
                                  double*, double*, double*, int*, double*,
                                  double*, double*, double*);

void flux_albo(void ** buf_src, void ** buf_dst, int * length)
{
    double ** data_src;
    double ** data_dst;
    bool *fluxAlbav;
    ...
    flux_albo_thucpl_(lats, lons, fluxAlbav, orbEccen, orbMvelpp,
