...
{
    EXECUTION_REPORT(REPORT_ERROR, false, "remap software error in set_parameter of Remap_operator_regrid\n");
}


void Remap_operator_regrid::calculate_remap_weights()
{
    EXECUTION_REPORT(REPORT_ERROR, false, "remap software error in calculate_remap_weights of Remap_operator_regrid\n");
}
...
{
    EXECUTION_REPORT(REPORT_ERROR, false, "remap software error in do_remap_values_caculation of Remap_operator_regrid\n");
}
...
{
    EXECUTION_REPORT(REPORT_ERROR, false, "remap software error in duplicate_remap_operator of Remap_operator_regrid\n");
    return NULL;
}
...
{
    EXECUTION_REPORT(REPORT_ERROR, false, "remap software error in generate_parallel_remap_operator of Remap_operator_regrid\n");
