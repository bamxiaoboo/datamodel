...
void IO_mgt::execute(const char*function, Remap_statement_operand **statement_operands, int num_operands)
{
    ...
    if (words_are_the_same(function, FUNCTION_WORD_ADD_NC_FILE) ||
        ...
        EXECUTION_REPORT(REPORT_ERROR, num_operands == 3, "function \"%s\" must have 3 arguments: one result parameter and two input parameters\n", function);
        ...
        EXECUTION_REPORT(REPORT_ERROR, num_operands == 3, "function \"%s\" must have 3 input parameters\n", function);
        ...
        EXECUTION_REPORT(REPORT_ERROR, num_operands == 2 || num_operands == 3, "function \"%s\" must have 2 or 3 input parameters\n", function);
        ...
        if (num_operands == 3) {
            ...
            EXECUTION_REPORT(REPORT_ERROR, words_are_the_same(statement_operands[2]->extension_names[0], "write_grid_name"),
        ...
        EXECUTION_REPORT(REPORT_ERROR, written_field_data->have_data_content(),
    ...
    else EXECUTION_REPORT(REPORT_ERROR, false, "function \"%s\" is unspported for IO object execution\n", function);
}
