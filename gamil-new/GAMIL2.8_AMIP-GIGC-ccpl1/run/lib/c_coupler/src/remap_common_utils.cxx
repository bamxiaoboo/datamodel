                                      ...
                                      int num_vertexes)
{
    ...
    EXECUTION_REPORT(REPORT_ERROR, num_vertexes <= 256, "remap software error in is_point_in_2D_sphere_coord_cell\n");
...
void rotate_sphere_coordinate(double lon_original, double lat_original, double &lon_rotated, double &lat_rotated)
{
    ...
    EXECUTION_REPORT(REPORT_ERROR, lon_rotated >= 0 && lon_rotated <= 360, "remap software error1 in rotate_sphere_coordinate\n");
    EXECUTION_REPORT(REPORT_ERROR, lat_rotated >= -90 && lat_rotated <= 90, "remap software error2 in rotate_sphere_coordinate\n");
