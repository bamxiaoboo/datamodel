...
void Remap_field_data_mgt::execute(const char*function, Remap_statement_operand **statement_operands, int num_operands)
{
    ...
    if (words_are_the_same(function, FUNCTION_WORD_READ_FIELD)) {
        EXECUTION_REPORT(REPORT_ERROR, num_operands == 4, "function \"%s\" for reading field data must have one result parameter and three input parameters\n", function);
        ...
        EXECUTION_REPORT(REPORT_ERROR, num_operands == 2 || num_operands == 3, "function \"%s\" for reading field data must have one result parameter and one or two input parameters\n", function);
        ...
        EXECUTION_REPORT(REPORT_ERROR, num_operands == 3, "function \"%s\" for reading field data must have one result parameter and two input parameter\n", function);
        ...
        EXECUTION_REPORT(REPORT_ERROR, num_operands == 2, "function \"%s\" must have two input parameters\n", function);
