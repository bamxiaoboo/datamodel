# 1 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/libs/c_coupler/External_Algorithms/flux_albedo.F90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/libs/c_coupler/External_Algorithms/flux_albedo.F90"
!===============================================================================
...
!
! !DESCRIPTION:
!   if flux\_albav/=0 (ie. "on" or "true") \!      Compute four effective daily avg surface albedos for all

!      combinations of visible/near-infrared and direct/diffuse radiation
!      without accounting for zenith angle (ie. a "daily average" albedo) \!   else \!      Compute four surface albedos for all combinations of visible/
...
!
! !DESCRIPTION:
!   if flux\_albav/=0 (ie. "on" or "true") \!     Impose a zenith angle dependance on the ice model "reference albedo".

!     Currently this only involves setting albedos to zero
!     on the dark side of the earth. \!   else \!     do not alter ice albedos
