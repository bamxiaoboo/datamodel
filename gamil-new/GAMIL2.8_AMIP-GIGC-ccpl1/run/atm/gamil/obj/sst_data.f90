# 1 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/ocnsice/dom/sst_data.F90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/ocnsice/dom/sst_data.F90"

# 1 "./misc.h" 1
# 2 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/ocnsice/dom/sst_data.F90" 2

# 1 "./params.h" 1
# 15 "./params.h"
 
 
# 3 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/ocnsice/dom/sst_data.F90" 2
!-----------------------------------------------------------------------
!
! MODULE: sst_data
!
...
# 140 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/ocnsice/dom/sst_data.F90" 2
...
# 141 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/ocnsice/dom/sst_data.F90" 2
        !---------------------------Local variables-----------------------------
...
10          continue
    ...
    subroutine sstint
        ...
        use rgrid,          only: nlon
        use comsrf,         only: ocnfrac, srfflx_state2d
        use c_coupler_interface_mod
...
!!    real(r8) divdampn         ! Number of days to invoke divergence damper
      real(r8) precc_thresh     ! Precipitation threshold for PRECCINT and PRECCFRQ
      real(r8) precl_thresh     ! Precipitation threshold for PRECLINT and PRECLFRQ
# 345 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/ocnsice/dom/sst_data.F90" 2
...
!-----------------------------------------------------------------------
      ...
      integer ncid_sst   ! sst dataset
      integer luhrest    ! history restart unit
# 346 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/ocnsice/dom/sst_data.F90" 2
!---------------------------Local variables-----------------------------
        integer cnt3(3)        ! array of counts for each dimension
        integer strt3(3)       ! array of starting indices
...
!
        ...
        do lchnk = begchunk, endchunk
            srfflx_state2d(lchnk)%sst(:) = sst(:,lchnk)
            ncol = get_ncols_p(lchnk)
            do i = 1, ncol
                if (ocnfrac(i,lchnk) >= 0.) then
                    srfflx_state2d(lchnk)%sst(:) = sst(:,lchnk)+tmelt  !! Liu Li modified: "+tmelt"
                end if
            end do
        end do
        return
