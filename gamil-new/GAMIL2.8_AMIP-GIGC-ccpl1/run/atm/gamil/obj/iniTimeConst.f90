# 1 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/iniTimeConst.F90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/iniTimeConst.F90"

# 1 "./misc.h" 1
# 2 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/iniTimeConst.F90" 2
...
# 3 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/iniTimeConst.F90" 2
...
! restart run, dtime is set in routine restrd()
  ...
  if (nsrest == 0) then
     do k = begpatch, endpatch
        clm(k)%dtime = c_coupler_get_step_size()
     end do
  endif
