# 1 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/physics/cam1/MG.F90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/physics/cam1/MG.F90"

# 1 "./misc.h" 1
# 2 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/physics/cam1/MG.F90" 2
...
# 38 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/physics/cam1/MG.F90" 2
...
!LIU Li        call addfld ('CCN3    ','#/cm3   ',pver, 'A','CCN concentration at S=0.1%',phys_decomp)
!LIU Li        call add_default('CCN3    ', 1, ' ')  !!sxj
...
!        call t_stopf("cldfrc_MG")
        ...
        do k=1,pver
            do i = 1,ncol
                 if (icimr(i,k) .gt. 1) write(6,*) "error1"
                 if (icwmr(i,k) .gt. 1) write(6,*) "error2"
            enddo
        enddo
