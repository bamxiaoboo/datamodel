# 1 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/inicFileMod.F90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/inicFileMod.F90"

# 1 "./misc.h" 1
# 2 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/inicFileMod.F90" 2
...
# 3 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/inicFileMod.F90" 2
...
# 187 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/inicFileMod.F90"
...
# 379 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/inicFileMod.F90"
...
! --------------------------------------------------------------------
    ...
    if (masterproc) then
       ...
       write(6,*)'(INICFILEMOD): Writing clm2 initial conditions dataset at ',&
            trim(loc_fn), 'at nstep = ',c_coupler_get_nstep()
       write(6,*)
...
# 655 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/inicFileMod.F90"
...
! -----------------------------------------------------------------
    ...
    call c_coupler_get_current_time (yr, mon, day, mcsec) 
    call c_coupler_get_previous_time (yrm1, monm1, daym1, mcsecm1)
...
# 962 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/inicFileMod.F90"
    return
...
# 1000 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/inicFileMod.F90"
    return
...
# 1043 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/inicFileMod.F90"
    return
...
# 1085 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/inicFileMod.F90"
    return
...
# 1127 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/inicFileMod.F90"
    return
...
# 1174 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/inicFileMod.F90"
    return
