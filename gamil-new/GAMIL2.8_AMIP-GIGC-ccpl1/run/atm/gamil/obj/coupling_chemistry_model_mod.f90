# 1 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/couple/c_coupler/coupling_chemistry_model_mod.F90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/couple/c_coupler/coupling_chemistry_model_mod.F90"
!***************************************************************
...
# 1 "./misc.h" 1
# 11 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/couple/c_coupler/coupling_chemistry_model_mod.F90" 2

# 1 "./params.h" 1
# 15 "./params.h"
 
 
# 12 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/couple/c_coupler/coupling_chemistry_model_mod.F90" 2
