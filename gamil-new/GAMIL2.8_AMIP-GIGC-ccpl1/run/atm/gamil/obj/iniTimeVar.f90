# 1 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/iniTimeVar.F90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/iniTimeVar.F90"

# 1 "./misc.h" 1
# 2 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/iniTimeVar.F90" 2
...
# 3 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/iniTimeVar.F90" 2
...
!$OMP PARALLEL DO PRIVATE (K)
  do k = begpatch, endpatch
     ...
     clm(k)%nstep = c_coupler_get_nstep()
