# 1 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/physics/cam1/diagnostics.F90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/physics/cam1/diagnostics.F90"

# 1 "./misc.h" 1
# 2 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/physics/cam1/diagnostics.F90" 2

# 1 "./params.h" 1
# 15 "./params.h"
 
 
# 3 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/physics/cam1/diagnostics.F90" 2
...
contains
    ...
    subroutine diag_dynvar(lchnk, ncol, state)
        ...
        use comsrf,        only: psl   ! sea-level pressure for coupling
...
!
        ...
        !
        if (c_coupler_is_first_step()) then  ! initialize trefmxav and trefmnav
        ...
        if (c_coupler_is_end_current_day()) then
