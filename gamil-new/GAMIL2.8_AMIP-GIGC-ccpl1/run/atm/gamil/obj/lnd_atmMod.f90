# 1 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/lnd_atmMod.F90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/lnd_atmMod.F90"

# 1 "./misc.h" 1
# 2 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/lnd_atmMod.F90" 2
...
# 3 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/lnd_atmMod.F90" 2
...
# 193 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/lnd_atmMod.F90"
...
!===============================================================================
  subroutine atm_to_lnd_checking(lnd_recv_buffer, lnd_recv_index, nsize)
    integer,  intent(in) :: nsize
    real(r8), intent(in) :: lnd_recv_buffer(16, 0:(nsize-1))
    integer,  intent(in) :: lnd_recv_index(begpatch:endpatch)
    integer              :: i, j, k
    write (*,*) "atm_to_lnd_checking!"
    do i = begpatch, endpatch
        k = lnd_recv_index(i)
        do j = 1, 16
            if (lnd_recv_buffer(j,k) /= scatter1d(j,i)) then
                write (*,*) "[ERROR1] patch=",i, "index=",j 
            endif
        enddo
    enddo
  end subroutine
