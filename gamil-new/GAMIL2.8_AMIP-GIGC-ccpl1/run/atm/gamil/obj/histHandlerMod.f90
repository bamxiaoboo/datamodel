# 1 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/histHandlerMod.F90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/histHandlerMod.F90"

# 1 "./misc.h" 1
# 2 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/histHandlerMod.F90" 2
...
# 3 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/histHandlerMod.F90" 2
          ...
          if (masterproc) then
             if (ntim(m) == 1) then
                ...
                write(6,*)'(HISTHANDLER): Creating history file ', &
                     trim(locfnh(m)),' at nstep = ',c_coupler_get_nstep()
                call histcrt (m)
             endif
          end if
...
# 457 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/histHandlerMod.F90"
...
! -----------------------------------------------------------------
    ...
    if (hist_freq == 0 ) then   !monthly
       call c_coupler_get_previous_time(yr, mon, day, sec)
