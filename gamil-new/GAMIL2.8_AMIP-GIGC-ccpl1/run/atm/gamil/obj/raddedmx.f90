# 1 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/physics/cam1/raddedmx.F90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/physics/cam1/raddedmx.F90"
...
!
   ...
   ! Yiran added
   real(r8) optdep(pcols,pver)   ! Total optical depth at each level
   ! Yiran added end
...
!
   ...
   do k=0,pver
      ...
      enddo
    enddo
    call out_fld_for_coupling_chem('OPTDEP', optdep, lchnk)
   ! Yiran added end
