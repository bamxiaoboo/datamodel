# 1 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/control/history.F90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/control/history.F90"

# 1 "./misc.h" 1
# 2 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/control/history.F90" 2

# 1 "./params.h" 1
# 15 "./params.h"
 
 
# 3 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/control/history.F90" 2
...
# 631 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/control/history.F90"
                  else
...
# 670 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/control/history.F90"
            end do
            if (masterproc) then
               close (unit=luhrest)
...
# 700 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/control/history.F90" 2
!-----------------------------------------------------------------------
!
! Arguments
!
      ...
      do t=1,mtapes
         do f=1,nflds(t)
            ...
            case (dyn_decomp)
               ...
               if ( dycore_is('LR') )then
# 835 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/control/history.F90"
               else
                  tape(t)%hlist(f)%field%begver = 1
                  tape(t)%hlist(f)%field%endver = numlev
               endif
...
!
            do f=1,nflds(t)
               ...
               case (dyn_decomp)
                  if ( dycore_is('LR') )then
# 957 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/control/history.F90"
                  else
...
# 993 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/control/history.F90"
            end do
!
...
!!    real(r8) divdampn         ! Number of days to invoke divergence damper
      real(r8) precc_thresh     ! Precipitation threshold for PRECCINT and PRECCFRQ
      real(r8) precl_thresh     ! Precipitation threshold for PRECLINT and PRECLFRQ
# 1090 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/control/history.F90" 2
!---------------------------Local variables-----------------------------
!
      integer t, f                   ! tape, field indices
...
!
# 1396 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/control/history.F90"
...
# 1481 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/control/history.F90"
...
!!    real(r8) divdampn         ! Number of days to invoke divergence damper
      real(r8) precc_thresh     ! Precipitation threshold for PRECCINT and PRECCFRQ
      real(r8) precl_thresh     ! Precipitation threshold for PRECLINT and PRECLFRQ
# 1820 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/control/history.F90" 2
...
!!    real(r8) divdampn         ! Number of days to invoke divergence damper
      real(r8) precc_thresh     ! Precipitation threshold for PRECCINT and PRECCFRQ
      real(r8) precl_thresh     ! Precipitation threshold for PRECLINT and PRECLFRQ
# 2234 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/control/history.F90" 2
...
# 2235 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/control/history.F90" 2
...
!
      ...
      integer :: k               ! ISCCP vertical index             !!(wh)
      integer :: l               ! ISCCP optical depth index        !!(wh)
      integer :: kl              ! ISCCP merged k and l indices     !!(wh)
      integer :: f               ! field index
      integer :: numlev          ! number of vertical levels (dimension and loop)
...
# 2270 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/control/history.F90"
...
!
      ...
      real(r8) prmid(npres)      ! pressure midpoints of ISCCP data          !!(wh)
      real(r8) taumid(ntau)      ! optical depth midpoints of ISCCP data     !!(wh)
      real(r8) prstau(npres*ntau)! prmid + taumid/1000                       !!(wh)
      ...
      integer dimen4n(4)         ! dimension ids (4d at isccp pressure levels)  !!(wh)
      integer londim             ! longitude dimension id
      integer latdim             ! latitude dimension id
      integer levdim             ! level dimension id
      integer ilevdim            ! interface dimension id
      integer isccp_prs_dim      ! dimension variable for ISCCP pressure levels      !!(wh)
      integer isccp_tau_dim      ! dimension variable for ISCCP tau values           !!(wh)
      integer isccp_prstau_dim   ! dimension variable for ISCCP pressure*tau levels  !!(wh)
      integer tbnddim            ! time_bnds dimension id
      integer levvar             ! level variable id
      integer ilevvar            ! intfc variable id
      integer isccp_prs_var      ! ISCCP mean pressure variable id                   !!(wh)
      integer isccp_tau_var      ! ISCCP mean optical depth variable id              !!(wh)
      integer isccp_prstau_var   ! ISCCP mixed variable id                           !!(wh)
...
!
      ...
      ret = nf_def_dim (nfid(t), 'isccp_prs', npres, isccp_prs_dim)              !!(wh)
      ret = nf_def_dim (nfid(t), 'isccp_tau', ntau, isccp_tau_dim)               !!(wh)
      ret = nf_def_dim (nfid(t), 'isccp_prstau', npres*ntau, isccp_prstau_dim)   !!(wh)
...
!
      ...
      dimen4n(1) = londim            !!(wh)
      dimen4n(2) = latdim            !!(wh)
      dimen4n(3) = isccp_prstau_dim  !!(wh)
      dimen4n(4) = timdim            !!(wh)

# 2393 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/control/history.F90"
...
# 2437 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/control/history.F90"
...
!!(wh 2005.01.28)-
      ...
      call c_coupler_get_start_time(yr, mon, day, nbsec)
...
# 2627 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/control/history.F90"
...
!!(wh 050128)+
         else if (numlev == npres*ntau) then
...
# 2727 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/control/history.F90"
...
!!(wh 2005.01.28)-
      ...
      call wrap_put_var_realx (nfid(t), isccp_prs_var, prmid)      !!(wh)
      call wrap_put_var_realx (nfid(t), isccp_tau_var, taumid)     !!(wh 2005.01.28)
      call wrap_put_var_realx (nfid(t), isccp_prstau_var, prstau)  !!(wh)
...
!
      ...
      case (dyn_decomp)
         ...
         if ( dycore_is('LR') )then
# 3151 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/control/history.F90"
         else
            coldimin = tape(t)%hlist(f)%field%coldimin
            numowned = coldimin*numlev
            call compute_gsfactors (numowned, numsend, numrecv, displs)
...
!-----------------------------------------------------------------------
      ...
      call c_coupler_get_num_elapsed_days_from_start(ndcur,nscur)  
!
...
!
            ...
            do f=1,nflds(t)
# 3331 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/control/history.F90"
               call dump_field (f, t)
            end do
...
!!    real(r8) divdampn         ! Number of days to invoke divergence damper
      real(r8) precc_thresh     ! Precipitation threshold for PRECCINT and PRECCFRQ
      real(r8) precl_thresh     ! Precipitation threshold for PRECLINT and PRECLFRQ
# 3393 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/control/history.F90" 2
...
# 3394 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/control/history.F90" 2
!
! Local variables
!
...
# 3542 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/control/history.F90"
...
# 3563 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/control/history.F90"
      if (masterproc) then

         dtime = c_coupler_get_step_size()
         nstep = c_coupler_get_nstep()
         call c_coupler_get_current_time(yr, mon, day, nbsec)
         nbdate = yr*10000 + mon*100 + day
         call c_coupler_get_current_time(yr, mon, day, ncsec)
         ncdate = yr*10000 + mon*100 + day
         call c_coupler_get_num_elapsed_days_from_start(ndcur,nscur)  
         ...
         call c_coupler_log_case_info_in_netcdf_file(id)
...
# 3622 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/control/history.F90"
!
! define variables to label the dimensions, use the same names as the
! dimensions
!
...
# 3666 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/control/history.F90"
...
# 3943 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/control/history.F90"
...
# 4000 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/control/history.F90"
      else
...
# 4014 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/control/history.F90"
      end if
...
# 4086 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/control/history.F90"
...
!
      ...
      do k=1,plev
         ...
         numi = nlon(j)
         jcen = j1 - 1 + j
         arr3d(:numi,k,j) = u3(i1:endi,jcen,k,n3m2)
      end do
      end do
...
!
      ...
      do k=1,plev
         ...
         numi = nlon(j)
         jcen = j1 - 1 + j
         arr3d(:numi,k,j) = v3(i1:endi,jcen,k,n3m2)
      end do
      end do
...
!
      ...
      do k=1,plev
         ...
         numi = nlon(j)
         jcen = j1 - 1 + j
         arr3d(:numi,k,j) = t3(i1:endi,jcen,k,n3m2)
      end do
      end do
...
!
      ...
      do k=1,plev
         ...
         numi = nlon(j)
         jcen = j1 - 1 + j
         arr3d(:numi,k,j) = q3(i1:endi,jcen,k,1,n3m2)
      end do
      end do
...
!
      do m=2,pcnst+pnats
         ...
         do k=1,plev
            ...
            numi = nlon(j)
            jcen = j1 - 1 + j
            arr3d(:numi,k,j) = q3(i1:endi,jcen,k,m,n3m2)
         end do
         end do
...
!!       arr2d(:numi,j) = ps(:numi,j,n3m1)
      ...
      deallocate (arr3d)
      deallocate (arr2dm)
# 4244 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/control/history.F90"
      return
...
!!    real(r8) divdampn         ! Number of days to invoke divergence damper
      real(r8) precc_thresh     ! Precipitation threshold for PRECCINT and PRECCFRQ
      real(r8) precl_thresh     ! Precipitation threshold for PRECLINT and PRECLFRQ
# 4389 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/control/history.F90" 2
!-----------------------------------------------------------------------
        ...
        ! 1. long wave
        !  (a) surface
        call addfld('FLUS    ', 'W/m2    ', 1,    'A', 'Long wave upward flux at surface',                    phys_decomp)
        call addfld('FLDS    ', 'W/m2    ', 1,    'A', 'Long wave downward flux at surface',                  phys_decomp)
        call addfld('FLNS    ', 'W/m2    ', 1,    'A', 'Long wave net flux at surface',                       phys_decomp)
        call addfld('FLDSC   ', 'W/m2    ', 1,    'A', 'Long wave clearsky downward flux at surface',         phys_decomp)
        ...
        !  (c) atmosphere top
        call addfld('FLUTOA  ', 'W/m2    ', 1,    'A', 'Long wave upward flux at top of atmosphere',          phys_decomp)
        call addfld('FLUTOAC ', 'W/m2    ', 1,    'A', 'Long wave clearsky upward flux at top of atmosphere', phys_decomp)
        !  (d) heating rate
        call addfld('QRL     ', 'K/s     ', pver, 'A', 'Long wave heating rate',                              phys_decomp)
        ! 2. short wave
        !  (a) surface
        call addfld('FSUS    ', 'W/m2    ', 1,    'A', 'Short wave upward flux at surface',                 phys_decomp)
        ...
        call addfld('FSUSC   ', 'W/m2    ', 1,    'A', 'Clear sky Short wave upward flux at surface',       phys_decomp)
        !  (b) model top
        ...
        !  (c) atmosphere top
        call addfld('FSUTOA  ', 'W/m2    ', 1,    'A', 'Short wave upward flux at top of atmosphere',       phys_decomp)
        call addfld('FSDTOA  ', 'W/m2    ', 1,    'A', 'Short wave downward flux at top of atmosphere',     phys_decomp)
        call addfld('FSNTOA  ', 'W/m2    ', 1,    'A', 'Short wave net flux at top of atmosphere',          phys_decomp)
        call addfld('FSUTOAC ', 'W/m2    ', 1,    'A', 'Short wave upward flux at top of atmosphere',       phys_decomp)
...
!
      ...
      case (dyn_decomp)
         ...
         if ( dycore_is('LR') )then
# 4801 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/control/history.F90"
         else
            masterlist(nfmaster)%field%begver   = 1
            masterlist(nfmaster)%field%endver   = numlev
         endif
...
!!    real(r8) divdampn         ! Number of days to invoke divergence damper
      real(r8) precc_thresh     ! Precipitation threshold for PRECCINT and PRECCFRQ
      real(r8) precl_thresh     ! Precipitation threshold for PRECLINT and PRECLFRQ
# 4863 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/control/history.F90" 2
...
# 4864 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/control/history.F90" 2
...
!
         if (lfill(t) .or. (nlend .and. nfils(t) >= 1) .or. (c_coupler_check_coupled_run_restart_time() .and. nfils(t) >= 1)) then
!
...
!
      do t=1,mtapes
         ...
         lhdisp = lhfill .or. (nlend .and. nfils(t) >= 1) .or. &
                              (c_coupler_check_coupled_run_restart_time() .and. nfils(t) >= 1)
