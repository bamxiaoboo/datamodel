# 1 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/restFileMod.F90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/restFileMod.F90"

# 1 "./misc.h" 1
# 2 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/restFileMod.F90" 2
...
# 3 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/restFileMod.F90" 2
...
# 45 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/restFileMod.F90"
  implicit none
...
! timemgr_restart from the cam restart files
    ...
    if (clm_nstep /= c_coupler_get_nstep() .and. .false.) then  ! add .false. by Li Liu for achieving hybrid run
       write(6,*)'(RESTRD): incompatibility in clm and cam restart dates'
       write(6,*)'  restart step from cam = ',c_coupler_get_nstep()
       write(6,*)'  restart step from clm = ',clm_nstep
       call endrun
    endif

# 226 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/restFileMod.F90"
...
! in routine iniTimeConst.F90)
    ...
    clm(begpatch:endpatch)%dtime = c_coupler_get_step_size()
...
# 445 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/restFileMod.F90"

! read data for flux coupled case, if appropriate

# 464 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/restFileMod.F90"
...
! -----------------------------------------------------------------
    ...
    if (masterproc) then
       write(6,*)
       write(6,'(72a1)') ("-",i=1,60)
       write(6,*) 'nstep = ',c_coupler_get_nstep()
...
! main restart data
    ...
    call wrtout (nio, c_coupler_get_nstep())
...
# 856 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/restFileMod.F90"
...
! -----------------------------------------------------------------
    ...
    if (masterproc) then
       ...
       if (c_coupler_check_coupled_run_finished()) lremove = .false.
...
! -----------------------------------------------------------------
    ...
    call c_coupler_get_current_time(yr, mon, day, sec)
...
# 1221 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/restFileMod.F90"
    return
...
# 1266 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/restFileMod.F90"
    return
...
# 1309 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/restFileMod.F90"
    return
...
# 1353 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/restFileMod.F90"
    return
...
# 1398 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/restFileMod.F90"
    return
...
# 1546 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/restFileMod.F90"
    return
...
# 1591 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/restFileMod.F90"
    return
...
# 1634 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/restFileMod.F90"
    return
...
# 1678 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/restFileMod.F90"
    return
...
# 1723 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/restFileMod.F90"
    return
