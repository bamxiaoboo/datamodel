# 1 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/mvegFileMod.F90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/mvegFileMod.F90"

# 1 "./misc.h" 1
# 2 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/mvegFileMod.F90" 2
...
# 3 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/lnd/CLM2/src/main/mvegFileMod.F90" 2
...
!-----------------------------------------------------------------------
    ...
    use clm_varmap  , only : landvec, numland
...
! ----------------------------------------------------------------------
    ...
    if (masterproc) then
       ...
       write (6,*) 'nstep = ',c_coupler_get_nstep(),' month = ',kmo,' day = ',kda
