# 1 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/dynamics/eul/HDIFUS.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/dynamics/eul/HDIFUS.F"

# 1 "./misc.h" 1
# 2 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/dynamics/eul/HDIFUS.F" 2

# 1 "./params.h" 1
# 15 "./params.h"
 
 
# 3 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/dynamics/eul/HDIFUS.F" 2
...
!
# 34 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/dynamics/eul/HDIFUS.F" 2
...
C
     ...
     _           ,V(ilbnd:ihbnd,beglatexdyn:endlatexdyn,NL)
     _            ,T(ilbnd:ihbnd,beglatexdyn:endlatexdyn,NL)
      REAL*8 QV(ilbnd:ihbnd,beglatexdyn:endlatexdyn,NL)


     
      REAL*8  TB(ilbnd:ihbnd,beglatexdyn:endlatexdyn,NL)
     _           ,PLY(ilbnd:ihbnd,beglatexdyn:endlatexdyn,NZ)
...
!$OMP PARALLEL DO PRIVATE (I,K,TMP_SUM1)
      ...
      TMP_SUM1   = ZERO
      DO I  = ibeg1,iend1
        TMP_SUM1 = TMP_SUM1 + HVK(I,60-1,K)
      ENDDO
      DTS_16(K) = TMP_SUM1
      ENDIF
      ENDDO
      ...
      call gamil_sum_pole_data_phys(60,DTS_16,NL)
...
!$OMP PARALLEL DO PRIVATE (I,J,TDN,QKN,EAN,TDS,QKSV,EAS,TMP_SUM1,TMP_SUM2,TMP_DATA1,TMP_DATA2)
      ...
      IF (jend0 .eq. 60) THEN   ! South pole
      ...
      DO I  = ibeg1,iend1
        EAS       = RDLT(I,60-1,K)
        TMP_DATA1  = EAS*(TDS - TK(I,60-1,K))
        TMP_DATA2 = EAS*(QKSV- HQK(I,60-1,K))
        TMP_SUM1   = TMP_SUM1 + TMP_DATA1
        TMP_SUM2  = TMP_SUM2 + TMP_DATA2
      ENDDO
      DTS_16(K)    = TMP_SUM1
      ...
      call gamil_sum_pole_data_phys(60,DTS_16,NL,DQS_16,NL)
