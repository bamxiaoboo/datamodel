# 1 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/control/filenames.F90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/control/filenames.F90"
!-----------------------------------------------------------------------
...
# 78 "/data3/work/yuxinzhu/test/gamil-new/model_platform/models/atm/GAMIL2.0_128x60/src/control/filenames.F90" 2
...
!
  ...
  if ( previous ) then
     call c_coupler_get_previous_time(year, month, day, ncsec)
  else
     call c_coupler_get_current_time(year, month, day, ncsec)
  end if
